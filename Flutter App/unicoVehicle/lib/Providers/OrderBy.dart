...
class OrderByProvider extends ChangeNotifier {
  Future<List<Order>> getOrderbyCustomer(int id) async {
    try {
      var response =
          await http.get(Uri.parse("${BaseURL.orderbyCustomer}/$id"));
      List<Order> orders = [];
      Order order = new Order();

      var orderBody = jsonDecode(response.body) as List<dynamic>;
      ...
      orderBody.map((body) {
        order = new Order(
          ...
          vehicle: new Vehicle(
            ...
            grossWeight:
                double.parse(body["vehicle"]["grossWeight"].toString()),
            groundClearance:
            ...
            vehicleFeatures: new VehicleFeatures(
              ...
              hasLowFuelLight: body["vehicle"]["vehicleFeatures"]
                  ["hasLowFuelLight"],
              hasLuggageNet: body["vehicle"]["vehicleFeatures"]
                  ["hasLuggageNet"],
              ...
              hasMileageMeter: body["vehicle"]["vehicleFeatures"]
                  ["hasMileageMeter"],
              hasNavigation: body["vehicle"]["vehicleFeatures"]
                  ["hasNavigation"],
              ...
              hasRangeMeter: body["vehicle"]["vehicleFeatures"]
                  ["hasRangeMeter"],
              ...
              hasTemperatureScale: body["vehicle"]["vehicleFeatures"]
                  ["hasTemperatureScale"],
              hasTrunkLight: body["vehicle"]["vehicleFeatures"]
                  ["hasTrunkLight"],
  ...
  Future<List<Order>> getOrderbyShowroom(int id) async {
    try {
      var response =
          await http.get(Uri.parse("${BaseURL.orderbyShowroom}/$id"));
      List<Order> orders = [];
      Order order = new Order();
  ...
  Future<List<Order>> getOrderbyShowroomCustomer(
      int showroomId, int customerId) async {
    try {
      ...
      var response = await http.get(Uri.parse(
          "${BaseURL.orderbyShowroomCustomer}/$showroomId?$queryParams"));
      List<Order> orders = [];
      Order order = new Order();
  ...
  Future<List<Order>> getOrderbyShowroomVehicle(
      int showroomId, int vehicleId) async {
    try {
      Map<String, String> params = {
        "vehicleId": "$vehicleId",
      };
      ...
      var response = await http.get(Uri.parse(
          "${BaseURL.orderbyShowroomVehicle}/$showroomId?$queryParams"));
      List<Order> orders = [];
      Order order = new Order();
